...
window.FAB_METABOX_SETTING = __assign(__assign({}, window.FAB_METABOX_SETTING), { 
    ...
    init: function () {
        ...
        jQuery('#field_fab_setting_type').trigger('change');
    }, 
    /**
     * Init select2 type
     * */
    ...
    initHotkeyOptions: function () {
        var dom = jQuery('#fab_setting_hotkey');
        if (dom) {
    ...
    triggerTypeChange: function (el) {
        ...
        jQuery("*[class*='fab-type-']").hide();
        /** Shows Links */
        if ('link' === value) {
            jQuery(".fab-type-link").show();
            jQuery(".fab-option-container-setting_link_behavior").show();
        }
        else if ('anchor_link' === value) {
            jQuery(".fab-type-link").show();
            jQuery(".fab-option-container-setting_link_behavior").hide();
        }
    } });
