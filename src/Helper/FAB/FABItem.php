...
class FABItem {
    ...
    public function __construct($ID)
    {
        ...
        $this->locations = ($this->locations) ? json_decode($this->locations, true) : [];
    ...
    public function match()
    {
        ...
        foreach($this->locations as $location){
            if($this->to_be_displayed) break; /** Break when rules exists/found */
    ...
    public function match_operator_and_value( $operator, $sourceValue, $comparedValue)
    {
        ...
        else if( '!=' == $operator && $sourceValue != $comparedValue){
            return true;
        }
    ...
    {
        return $this->WP->esc('attr',$this->ID);
    }
    ...
    {
        return $this->WP->esc('attr',$this->title);
    }
    ...
    {
        return $this->WP->esc('attr',$this->slug);
    }
    ...
    {
        return ($this->icon_class) ? $this->WP->esc('attr',$this->icon_class) : 'fas fa-circle';
    }
    ...
    {
        return $this->WP->esc('attr',$this->type);
    }
    ...
    {
        return $this->WP->esc('attr',$this->link);
    }
    ...
    {
        return $this->WP->esc('attr',$this->linkBehavior);
    }
    ...
    {
        return $this->WP->esc('attr',$this->hotkey);
    }
    ...
    {
        return $this->WP->esc('attr',$this->to_be_displayed);
    }
