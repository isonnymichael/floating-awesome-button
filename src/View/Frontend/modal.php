...
<?php foreach ( $fab_to_display as $fab_item ) : ?>
    ...
    <style>
        ...
        .jconfirm-fab-modal-<?php echo esc_attr( $fab_item->getID() ); ?> .jconfirm-box {
            ...
            /** Modal Content */
            <?php echo ( $fab_item->getModal()->getLayout()['content']['overflow'] ) ? 'overflow: visible !important;' : ''; // Overflow ?>
        }
        /** Modal Background */
        .jconfirm-fab-modal-<?php echo esc_attr( $fab_item->getID() ); ?> .jconfirm-bg {
            <?php
                ...
                /** Opacity */
                $opacity = isset($fab_item->getModal()->getLayout()['background']['opacity']) ? $fab_item->getModal()->getLayout()['background']['opacity'] : '';
